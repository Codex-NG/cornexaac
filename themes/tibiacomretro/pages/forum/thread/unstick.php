...
<form method="POST">
    ...
    <table>
        <tr class="header">
            <th colspan="2">Unstick thread <?php echo e($thread->title); ?></th>
        </tr>
        <tr>
            <td colspan="2">Are you sure you want to unstick thread <strong><?php echo e($thread->title); ?></strong> by <strong><?php echo playerIdToName($thread->posted_by); ?></strong>?</td>
        </tr>
