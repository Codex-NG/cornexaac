...
<form method="POST">
    ...
    <table>
        <tr class="header">
            <th colspan="2">Stick thread <?php echo e($thread->title); ?></th>
        </tr>
        <tr>
            <td colspan="2">Are you sure you want to stick thread <strong><?php echo e($thread->title); ?></strong> by <strong><?php echo playerIdToName($thread->posted_by); ?></strong>?</td>
        </tr>
